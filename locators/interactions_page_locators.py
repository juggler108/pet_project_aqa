...
class DraggablePageLocators:
    ...
    # axis restricted
    RESTRICTED_TAB = (By.CSS_SELECTOR, "#draggableExample-tab-axisRestriction")
    RESTRICTED_ONLY_X = (By.CSS_SELECTOR, "#restrictedX")
    RESTRICTED_ONLY_Y = (By.CSS_SELECTOR, "#restrictedY")
